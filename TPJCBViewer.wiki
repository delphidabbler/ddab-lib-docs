...
_TPJCBViewer_ notifies the user of changes to the Windows clipboard. It registers itself with Windows to receive notifications whenever the contents of the clipboard change. When a change is detected the _[TPJCBViewerOnClipboardChanged OnClipboardChanged]_ event is triggered. Users handle this event.
