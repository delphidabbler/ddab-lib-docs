...
The ini file to be used is specified using the _[TPJWdwStateIniRootDir IniRootDir]_*^v5.5^* and _[TPJWdwStateIniFileName IniFileName]_ property and the name of the section of the ini file to be used is given by the _[TPJWdwStateSection Section]_ property. Alternatively the _[TPJWdwStateOnGetIniData OnGetIniData]_ or _[TPJWdwStateOnGetIniDataEx OnGetIniDataEx]_*^v5.5^* event can be handled and used to set the required ini file name and section.
...
|| _[TPJWdwStateIniFilePath IniFilePath]_*^v5.5^* || Returns the fully specified name of the ini file used to store window state information. ||
...
|| _[TPJWdwStateIniFileName IniFileName]_ || Determines the name of the ini file used to record window information. If this file name is relative then its root directory is given by the _[TPJWdwStateIniRootDir IniRootDir]_*^v5.5^* property. ||
|| _[TPJWdwStateIniRootDir IniRootDir]_*^v5.5^* || Identifies the root directory where the ini file will be stored if _[TPJWdwStateIniFileName IniFileName]_ is a relative path. ||
...
|| _[TPJWdwStateOnGetIniDataEx OnGetIniDataEx]_*^v5.5^* || Event that allows user to change the name of the root directory of name of the ini file and the section within it where window information is stored. ||
