...
|| `bgUnknown` || An unsupported or unknown group of buttons. This item is for use in _[TPJVCLMsgDlg TPJVCLMsgDlg]_ and should not be selected in _TPJWinMsgDlg_. If it is selected it has the same effect as `bgOK`. ||
...
Setting _!ButtonGroup_ also updates the _[TPJWinMsgDlgDlgType DlgType]_ property and vice versa. See the _[TPJWinMsgDlgDlgType DlgType page]_ for full details.

To include a help button in the dialogue box set the _[TPJWinMsgDlgHelpContext HelpContext]_ property to some non-zero value.
