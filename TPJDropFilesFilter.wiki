#summary Description of the TPJDropFiles.Filter property
<wiki:comment>
$Rev$
$Date$
</wiki:comment>
...
Any files that pass the filter are then passed to the _[TPJDropFilesOnFileFilter OnFileFilter]_ event, if handled.
