#summary Description of the TPJResourceFile.AddEntry methods.
<wiki:comment>
$Rev$
$Date$
</wiki:comment>
...
There are two overloaded _!AddEntry_ methods. They are both used to create a new resource entry within the resource file represented by a _[TPJResourceFile TPJResourceFile]_ object.
...
*_Parameters:_*
  ...
  * _!ResType_: The type of the new resource (ordinal or string).
  * _!ResName_: The name of the new resource (ordinal or string).
...
Adds a copy of an existing resource entry to the resource file object with a new resource name and language id. The new entry has the same resource type as the one being copied.
  ...
  * _!ResName_: Name of the new resource.
  * _LangID_: Optional language id of the resource (a language neutral value of 0 is used if this parameter is not provided).
