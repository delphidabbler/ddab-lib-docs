...
| [Console Application Runner Classes](ConsoleAppClasses.md) | Classes to control the execution of child console application processes and to redirect input and output where required. |
...
| [MD5 Message Digest Unit](MD5Unit.md) | Implementation of the MD5 Message Digest Algorithm as a Delphi class. This is an implementation from scratch, not a wrapper round earlier code. |
...
| [Stream Extension Classes](StreamExtensionClasses.md) | Classes that provide a means to wrap _TStream_ objects. Also provides implementations of the _IStream_ interface. |
