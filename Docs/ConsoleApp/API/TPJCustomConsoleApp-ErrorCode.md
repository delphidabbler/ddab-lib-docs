...
| `$20000002` | [_cAppErrorTerminated_](./Console.md#capperrorterminated) | Application was forcibly terminated (see the [_Terminate_](./TPJCustomConsoleApp-Terminate.md) method). |
...
To check for application errors, use the constants from the table and AND them with the [_cAppErrorMask_](./Console.md#capperrormask) constant. For example:
