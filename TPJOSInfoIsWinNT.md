...
[v5.0] On operating systems where _[TPJOSInfoCanSpoof CanSpoof]_ returns `False` this method will always return `True`, because _[TPJOSInfoCanSpoof CanSpoof]_ only ever returns `False` on NT systems.