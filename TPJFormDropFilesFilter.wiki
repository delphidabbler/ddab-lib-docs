#summary Description of the TPJFormDropFiles.Filter property
<wiki:comment>
$Rev$
$Date$
</wiki:comment>
...
Any files that pass the filter are then passed to the _[TPJFormDropFilesOnFileFilter OnFileFilter]_ event, if handled.
