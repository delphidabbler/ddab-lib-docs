#summary Description of the TPJWinMsgDlg.IconResource property
<wiki:comment>
$Rev$
$Date$
</wiki:comment>
...
The _[TPJWinMsgDlgKind Kind]_ property must be set to `mkUser` in order to display a user defined icon, otherwise _!IconResource_ is ignored.
