#summary Description of the TPJOSInfo.IsReallyWindowsXXX class methods
<wiki:comment>
$Rev$
$Date$
</wiki:comment>
...
|| _!IsReallyWindows2000OrGreater_ || Checks whether the OS is Windows 2000 or greater. ||
...
|| _!IsReallyWindows7OrGreater_ || Checks whether the OS is Windows 7 or greater. ||
|| _IsReallyWindows7SP1OrGreater_ || Checks whether the OS is Windows 7 Service Pack 1 or greater. ||
|| _!IsReallyWindows8OrGreater_ || Checks whether the OS is Windows 8 or greater. ||
|| _!IsReallyWindows8Point1OrGreater_ || Checks whether the OS is Windows 8.1 or greater. ||
|| _!IsReallyWindowsVistaOrGreater_ || Checks whether the OS is Windows Vista or greater. ||
