...
Setting _Kind_ also updates the _[TPJWinMsgDlgDlgType DlgType]_ property and vice versa. See the _[TPJWinMsgDlgDlgType DlgType page]_ for full details.
...
*Notes:*
  ...
  # `mkUnknown` should not be selected explicitly. It is present to signal that an invalid dialogue kind has been specified when setting the _[TPJWinMsgDlgDlgType DlgType]_ property.
