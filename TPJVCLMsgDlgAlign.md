...
|| `mdaScreenOffset` || The dialogue is offset from the top left corner of the screen by the amount given by the values of the _[TPJVCLMsgDlgOffsetLeft OffsetLeft]_ and _[TPJVCLMsgDlgOffsetTop OffsetTop]_ properties. ||
...
|| `mdaFormOffset` || The dialogue is offset relative to the top left corner of the owning form by the amount given by the values of the _[TPJVCLMsgDlgOffsetLeft OffsetLeft]_ and _[TPJVCLMsgDlgOffsetTop OffsetTop]_ properties. If no owing form can be found the dialogue is offset relative to the screen. ||
