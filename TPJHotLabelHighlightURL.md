#summary Description of the TPJHotLabel.HighlightURL property
<wiki:comment>
$Rev$
$Date$
</wiki:comment>
...
When this property is `True` the label's text is highlighted using the font defined by the _[TPJHotLabelHighlightFont HighlightFont]_ property. When _HighlightURL_ is `False` the text is not highlighted and the _[TPJHotLabelHighlightFont HighlightFont]_ property is ignored.
