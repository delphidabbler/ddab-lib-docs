#summary Resource File Helper Routines.
<wiki:comment>
$Rev$
$Date$
</wiki:comment>
...
This is a clone of the `IS_INTRESOURCE` macro defined on MSDN that checks if a resource identifier is ordinal or a string. Complements the _!MakeIntResource_ "macro" defined in _Windows.pas_.

*_Parameter:_*

  * _ResID_: The resource identifier to be checked. May be either an numeric identifier (like those produced by _!MakeIntResource_, or a name in the form of a null terminated string.
